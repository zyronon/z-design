...
import {EventTypes, RectColorType, ShapeType} from "./utils/type";
...
import {TextAlign} from "./config/TextConfig";
...
export default function Design() {
  ...
  const [selectShape, setSelectShape] = useState(null as any)
  const [handScale, setHandScale] = useState(defaultConfig.handScale)
  const [cu, setCu] = useState<CanvasUtil2>(null as any)
  const canvasRef: any = useRef(null)
  const [selectDrawType, setSelectDrawType] = useState('')
  const [drawType, setDrawType] = useState<ShapeType>(ShapeType.SELECT)
  const [drawType2, setDrawType2] = useState<ShapeType>(ShapeType.FRAME)
  const [drawType3, setDrawType3] = useState<ShapeType>(ShapeType.RECTANGLE)
  const [drawType4, setDrawType4] = useState<ShapeType>(ShapeType.PEN)
  const [drawType5, setDrawType5] = useState<ShapeType>(ShapeType.TEXT)
  const [drawType6, setDrawType6] = useState<ShapeType>(ShapeType.MOVE)
  const [showPicker, setShowPicker] = useState(false)
  const [rectColor, setRectColor] = useState(null)
  const [rectColorType, setRectColorType] = useState('')
  ...
  function setCanvasUtilMode(mode: ShapeType, key: any) {
    // @ts-ignore
  ...
  const selectRectConf = useCreation(() => {
    return selectShape?.conf
  }, [selectShape])

  const setFillColor = useMemoizedFn(()=>{
    setShowPicker(!showPicker)
    setRectColor(selectRectConf.fillColor)
    setRectColorType(RectColorType.FillColor)
  })

  const setBorderColor = useMemoizedFn(()=>{
    setShowPicker(!showPicker)
    setRectColor(selectRectConf.borderColor)
    setRectColorType(RectColorType.BorderColor)
  })

  return <div className={cx('design', {'white': hide})}>
          ...
          <div className="left">
            <div className={cx('tool select', selectDrawType === 'drawType' && 'active')}>
              <BaseSelect
                ...
                onChange={(e: any) => setCanvasUtilMode(e, 'drawType')}>
            ...
            <div className={cx('tool select', selectDrawType === 'drawType2' && 'active')}>
              <BaseSelect
                ...
                onChange={(e: any) => setCanvasUtilMode(e, 'drawType2')}>
            ...
            <div className={cx('tool select', selectDrawType === 'drawType3' && 'active')}>
              <BaseSelect
                ...
                onChange={(e: any) => setCanvasUtilMode(e, 'drawType3')}>
            ...
            <div className={cx('tool select', selectDrawType === 'drawType4' && 'active')}>
              <BaseSelect
                ...
                onChange={(e: any) => setCanvasUtilMode(e, 'drawType4')}>
            ...
            <div className={cx('tool', selectDrawType === 'drawType5' && 'active')}
                 onClick={() => setCanvasUtilMode(ShapeType.TEXT, 'drawType5')}>
              <Icon type={'Text'} size="20"/>
            </div>
            <div className={cx('tool', selectDrawType === 'drawType6' && 'active')}
                 onClick={() => setCanvasUtilMode(ShapeType.MOVE, 'drawType6')}>
              ...
              <>
                ...
                <div className="base-info">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <BaseButton active={selectRectConf?.flipHorizontal} onClick={() => flip(0)}>
                        <FlipIcon style={{fontSize: "16rem", 'transform': 'rotate(-90deg)'}}/>
                      </BaseButton>
                      <BaseButton active={selectRectConf?.flipVertical} onClick={() => flip(1)}>
                ...
                <div className="base-info">
                  ...
                  <div className="row-single">
                    <div className="col">
                      ...
                      >
                        <div className={'test'}>
                          <input type="text" value={selectRectConf?.fillColor} onChange={inputOnChange}/>
                          <input type="text"/>
                        </div>
                      </BaseSlotButton>
                    </div>
                ...
                <div className="base-info">
                  ...
                  <div className="row-single">
                    <div className="col">
                      ...
                      >
                        <div className={'test'}>
                          <input type="text" value={selectRectConf?.borderColor} onChange={inputOnChange}/>
                          <input type="text"/>
                        </div>
                      </BaseSlotButton>
                    </div>
